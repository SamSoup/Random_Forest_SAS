...
Generate x input samples from console input, of 50%-50% SAS vs neutral split
```{r}
rho_start <- 75
rho_end <- 400
...
```{r}
library(knitr)
if (file.exists("GenerateInput.R")) {
  file.remove("GenerateInput.R")
}
knitr::purl("GenerateInput.Rmd")
```
